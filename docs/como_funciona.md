...
| **LLM solo en el chatbot** *(planeado)* | El único componente con LLM será el chatbot que responde preguntas **sobre un reporte ya generado**. No re-ejecuta ni cambia hallazgos ni montos. | Se puede conversar con el reporte sin romper el determinismo del resultado. |
